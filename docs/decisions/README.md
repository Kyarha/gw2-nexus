...
- [ADR-0005: Coordinate action mechanism: overlay marker + clipboard, not map-control or chat-injection](adr-0005-coordinate-action-mechanism.md) — Spec 003 (Notes MVP) makes a note's coordinate *actionable*: "show it on the map" (UC-6) and "share it to chat" (UC-7). (2026-08-13, Accepted)
